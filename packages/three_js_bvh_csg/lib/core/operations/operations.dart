    ...
    for (var ib = 0, l = triangles.length; ib < l; ib++) {
      ...
      if (_attr.isNotEmpty) {
        ...
        for (var k = 0, lk = _attr.length; k < lk; k++) {
          ...
          final invertTri = action == INVERT_TRI;
          appendAttributeFromTriangle(
              ia, _barycoordTri, a.geometry, a.matrixWorld, _normalMatrix, attrSet, invertedGeometry != invertTri);
        }
      }
    }
  }
        ...
        if (!isTriDegenerate(_tri)) {
          for (var k = 0, lk = _attr.length; k < lk; k++) {
            ...
            appendAttributesFromIndices(
                i0, i1, i2, aAttributes, a.matrixWorld, _normalMatrix, attrSet, invertTri != invertedGeometry);
          }
        }
      }
    }
