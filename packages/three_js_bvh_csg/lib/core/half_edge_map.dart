  ...
  void updateFrom(geometry) {
    ...
    String hashAllAttributes(int i) {
      ...
      for (int k = 0, l = attrKeys.length; k < l; k++) {
        var attr = attributes[attrKeys[k]];
        var str;
    ...
    if (useDrawRange) {
      ...
      if (geometry.drawRange.count != double.infinity) {
    ...
    this.unmatchedEdges = unmatchedSet.length;
    this.data = data;
  }
