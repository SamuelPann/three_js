...
const double DEGENERATE_EPSILON = 1e-8;
...
void matchEdges(List<dynamic> forward, List<dynamic> reverse, Map<int, List<int>> disjointConnectivityMap,
    [double eps = DEGENERATE_EPSILON]) {
